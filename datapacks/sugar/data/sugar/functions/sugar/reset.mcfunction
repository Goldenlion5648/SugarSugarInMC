...
scoreboard objectives add sugar_for_current_level dummy
...
scoreboard objectives add remaining_sugar_required_to_progress dummy
scoreboard players set global remaining_sugar_required_to_progress 0
